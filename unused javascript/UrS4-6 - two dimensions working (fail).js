...
function filterWheelSizes(checkBox) {
  checkBox.addEventListener("change", (e) => {
    ...
    if (e.target.checked === true) {
      ...
      if((wheelSizeChecked()) && ((!wheelBrandChecked()) && (!bodyTypeChecked()))){
        ...
        galleryItems.forEach((item) => {
          if(item.dataset.wheelsize === checkBox.dataset.size){ // checks for the items in the gallery that have the value the checkbox is looking for
    ...
    if (e.target.checked === false) { 
      ...
      if((!wheelSizeChecked())){
        galleryItems.forEach((item) => {
          if((item.dataset.wheelsize !== checkBox.dataset.size) && ((item.dataset.bodyfilter === "true") || (item.dataset.brandfilter === "true"))){ 
            item.style.display = "flex"; // shows that item again
            console.log("panera bread");
        }});
      }
      ...
      if((wheelSizeChecked()) && ((!wheelBrandChecked()) && (!bodyTypeChecked()))){
        galleryItems.forEach((item) => {
          if(item.dataset.wheelsize === checkBox.dataset.size){ // checks for the items in the gallery that have the value the checkbox is looking for
            ...
            console.log("nothing else was checked, so we can reset just the wheel size jawn");
          }
        })
      }
      ...
      if((wheelSizeChecked()) && ((!wheelBrandChecked()) && (bodyTypeChecked()))){
        ...
        galleryItems.forEach((item) => {
          if(item.dataset.wheelsize === checkBox.dataset.size){ // checks for the items in the gallery that have the value the checkbox is looking for
            ...
            if(!wheelSizeChecked()){
              //so if we have no more wheelsize filters, we can display all sizes..
              console.log("do i have to do something here?");
            }
          }
        })
      }
    ...
    checkBox.addEventListener("change", (e) => {
      ...
      if (e.target.checked === true) {
        ...
        if((!wheelSizeChecked()) && ((!wheelBrandChecked()) && (bodyTypeChecked()))){
          console.log("only one dimension checked");
          galleryItems.forEach((item) => {
            if(item.dataset.cartype === checkBox.dataset.cartype){ // checks for the items in the gallery that have the value the checkbox is looking for
      ...
      if (e.target.checked === false) { 
        ...
        if((!bodyTypeChecked())){
          galleryItems.forEach((item) => {
            if((item.dataset.cartype !== checkBox.dataset.cartype) && ((item.dataset.sizefilter === "true") || (item.dataset.brandfilter === "true"))){ 
              item.style.display = "flex"; // shows that item again
      ...
      checkBox.addEventListener("change", (e) => {
        ...
        if (e.target.checked === true) {
          ...
          if((!wheelSizeChecked()) && ((wheelBrandChecked()) && (!bodyTypeChecked()))){
            console.log("only one dimension checked");
            galleryItems.forEach((item) => {
              if(item.dataset.brand === checkBox.dataset.brand){ // checks for the items in the gallery that have the value the checkbox is looking for
        ...
        if (e.target.checked === false) { 
          ...
          if((!bodyTypeChecked())){
            galleryItems.forEach((item) => {
              if((item.dataset.brand !== checkBox.dataset.brand) && ((item.dataset.sizefilter === "true") || (item.dataset.brandfilter === "true"))){ 
                item.style.display = "flex"; // shows that item again
                console.log("panera bread the long way");
            }});
          }
